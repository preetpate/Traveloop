          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-xl text-gray-600">
                Start your journey with us. Create an account and unlock amazing travel planning features.
              </p>
            </div>
            
            <div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-3xl p-8 text-white">
              <h3 className="text-2xl font-bold mb-4">Why Choose Traveloop?</h3>
              <ul className="space-y-3">
                ...
                <li className="flex items-center gap-3">
                  ...
                  <span>Track budgets & expenses</span>
                </li>
                <li className="flex items-center gap-3">
                  <svg className="w-6 h-6 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    } rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 transition`}
                  />
                </div>
